...
while True:
    ...
    if opcion == "1":
        ...
        print("\nPARTIDOS GANADOS, PERDIDOS Y EMPATADOS POR CADA EQUIPO")
        ...
        print("\nGOLES MARCADOS POR CADA EQUIPO LOCAL")
        ...
        print("\nGOLES MARCADOS POR CADA EQUIPO VISITANTE")
        ...
        # (PUNTO 8) Calcular la cantidad total de partidos por equipo
        total_partidos = 0
        ...
        print("\nGOLES MARCADOS POR CADA EQUIPO COMO LOCAL Y COMO VISITANTE")
        # Imprimir la cantidad de goles marcados por cada equipo jugando como local y como visitante
        for equipo in equipos:
            print(equipo + ": " + (goles_equipo_local[equipo]) + " goles como local y " + str(goles_equipo_visitante[equipo]) + " goles como visitante")
        ...
        print("\nPARTIDOS DEL EQUIPO " + nombre_equipo)
        for i in range(len(equipos_locales)):
